    ...
    <div class="container max-w-max mx-auto px-4">
        ...
        <hr>
            ...
            <div class="flex justify-center mt-4">
                ...
                <a href="{{ url('/advertisers/create?schedule_id=' . $schedule->id) }}" class="w-40 bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded mr-2 text-center">Add Advertiser</a>
